...
namespace SpecsSample
{
    ...
    public class ContractMultiplicationSteps
    {
        ...
        public void GivenIHaveDeployedAMultiplicationContractWithMultiplerOf(int multiplier)
        {
            ...
            var transactionHash =
                    ...
                    web3.Eth.DeployContract.SendRequestAsync(abi, contractByteCode, addressFrom,
                        new HexBigInteger(900000), multiplier).Result;
        ...
        public void WhenICallMultiplyUsing(int multiplier)
        {
            ...
            var callResult = multiplyFunction.CallAsync<int>(multiplier).Result;
